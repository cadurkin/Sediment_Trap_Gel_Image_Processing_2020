...
data_flux_combined = flux_combined(data_flux_allMags,437,109,38,11)
...
data_agg_flux_combined = flux_combined(data_agg_flux_allMags,437,109,38,11)
data_long_flux_allMags = Particle_flux(data_sinking,time,'long_fecal_pellet')
data_long_flux_combined = flux_combined(data_long_flux_allMags,437,109,38,11)
data_large_flux_allMags = Particle_flux(data_sinking,time,'large_loose_pellet')
data_large_flux_combined = flux_combined(data_large_flux_allMags,437,109,38,11)
data_short_flux_allMags = Particle_flux(data_sinking,time,'short_pellet')
data_short_flux_combined = flux_combined(data_short_flux_allMags,437,109,38,11)
data_mini_flux_allMags = Particle_flux(data_sinking,time,'mini_pellet')
data_mini_flux_combined = flux_combined(data_mini_flux_allMags,437,109,38,11)
data_dense_flux_allMags = Particle_flux(data_sinking,time,'dense_detritus')
data_dense_flux_combined = flux_combined(data_dense_flux_allMags,437,109,38,11)
data_phyto_flux_allMags = Particle_flux(data_sinking,time,'phytoplankton')
data_phyto_flux_combined = flux_combined(data_phyto_flux_allMags,437,109,38,11)
data_foraminifera_flux_allMags = Particle_flux(data_sinking,time,'foraminifera')
data_foraminifera_flux_combined = flux_combined(data_foraminifera_flux_allMags,437,109,38,11)
data_rhizaria_flux_allMags = Particle_flux(data_sinking,time,'rhizaria')
data_rhizaria_flux_combined = flux_combined(data_rhizaria_flux_allMags,437,109,38,11)
data_copepod_flux_allMags = Particle_flux(data,time,'copepod')
data_copepod_flux_combined = flux_combined(data_copepod_flux_allMags,437,109,38,11)
data_amphipod_flux_allMags = Particle_flux(data,time,'amphipod')
data_amphipod_flux_combined = flux_combined(data_amphipod_flux_allMags,437,109,38,11)
data_zooplankton_flux_allMags = Particle_flux(data,time,'zooplankton')
data_zooplankton_flux_combined = flux_combined(data_zooplankton_flux_allMags,437,109,38,11)
data_zooplankton_part_flux_allMags = Particle_flux(data,time,'zooplankton_part')
data_zooplankton_part_flux_combined = flux_combined(data_zooplankton_part_flux_allMags,437,109,38,11)
data_fiber_flux_allMags = Particle_flux(data,time,'fiber')
data_fiber_flux_combined = flux_combined(data_fiber_flux_allMags,437,109,38,11)
data_unidentifiable_flux_allMags = Particle_flux(data,time,'unidentifiable')
data_unidentifiable_flux_combined = flux_combined(data_unidentifiable_flux_allMags,437,109,38,11)
data_pteropod_flux_allMags = Particle_flux(data,time,'pteropod')
data_pteropod_flux_combined = flux_combined(data_pteropod_flux_allMags,437,109,38,11)
data_salp_pellet_flux_allMags = Particle_flux(data,time,'salp_pellet')
data_salp_pellet_flux_combined = flux_combined(data_salp_pellet_flux_allMags,437,109,38,11)
